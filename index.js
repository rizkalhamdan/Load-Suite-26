load.setup(1, 0, 1, 0) // Not constant

// Delete it for new version .. 10.12.2025
// document.querySelector('html').style.setProperty("--main-color", "#44ff88")
// document.querySelector('html').style.setProperty("--main-opaci", "#44ff8899")
...
load.snooze = function() {
  nagh.head({...publ_head, keywords: "About load suite, Load Suite 26, Naghoom, naghoom.js"})
}
...
function go(title, dis, btn, fun) {
  var about = nagh.na( {classes: "rc go", preload: 1000} )
...
go("<u>Developer Guide</u>", `Get Quick Developer Guidelines now`, nagh.get_icon_rounded("developer_guide"), _=> location.assign('developer-guide/'))

go("Quick setup", "I know how install and setup the suite.", nagh.get_icon_rounded("cloud_download"), _=> location.assign('quick/'))
